...
<section>
    ...
    <table>
        ...
        <tr>
            ...
            <th>Localisation de la faculté</th>
            <th>Modifier</th>
            <th>Supprimer</th>
        </tr>
        </thead>
        ...
        <?php foreach ($elements_page as $element) : ?>
            <tr>
                <td><?= $element['faculte_nom'] ?></td>
                <td><?= $element['faculte_local'] ?></td>
                <td><a href="#"><img src="style/images/pen.png" alt=""></a></td>
                <td><a href="faculte_del.php?id=<?=$element['faculte_id']?>"><img src="style/images/poubelle.png" alt=""></a></td>
