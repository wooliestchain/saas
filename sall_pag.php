...
<section>
    ...
    <table>
        ...
        <tr>
            ...
            <th>Localisation de la salle</th>
            <th>Modifier</th>
            <th>Supprimer</th>
        </tr>
        </thead>
        ...
        <?php foreach ($elements_page as $element) : ?>
            <tr>
                <td><?= $element['salle_nom'] ?></td>
                <td><?= $element['salle_local'] ?></td>
                <td><a href="#"><img src="style/images/pen.png" alt=""></a></td>
                <td><a href="salle_del.php?id=<?=$element['salle_id']?>"><img src="style/images/poubelle.png" alt=""></a></td>
